# code-request-application/flake.nix
#
# This file packages pythoneda-artifact/code-request-application as a Nix flake.
#
# Copyright (C) 2023-today rydnr's pythoneda-artifact/code-request-application-artifact
#
...
# along with this program.  If not, see <https://www.gnu.org/licenses/>.
{
  ...
  inputs = rec {
    ...
    pythoneda-artifact-code-request-infrastructure = {
      ...
      url =
        "github:pythoneda-artifact/code-request-infrastructure-artifact/0.0.2?dir=code-request-infrastructure";
    };
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in rec {
        ...
        devShells = rec {
          ...
          pythoneda-artifact-code-request-application-raw-python38 =
          ...
          pythoneda-artifact-code-request-application-raw-python39 =
            shared.raw-devShell-for {
              package =
                packages.pythoneda-artifact-code-request-application-python39;
              python = pkgs.python39;
          ...
          pythoneda-artifact-code-request-application-raw-python310 =
            shared.raw-devShell-for {
              package =
                packages.pythoneda-artifact-code-request-application-python310;
              python = pkgs.python310;
          ...
          pythoneda-artifact-code-request-application-raw-python311 =
            shared.raw-devShell-for {
              package =
                packages.pythoneda-artifact-code-request-application-python311;
              python = pkgs.python311;
