...
# along with this program.  If not, see <https://www.gnu.org/licenses/>.
{
  ...
  inputs = rec {
    ...
    pythoneda-artifact-code-request-infrastructure = {
      url =
        "github:pythoneda-artifact/code-request-infrastructure-artifact/0.0.1a1?dir=code-request-infrastructure";
  ...
  outputs = inputs:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        version = "0.0.1a2";
        sha256 = "sha256-Z1oY082wig6SlpTS+361cmLwCLoebBhaNDuUQLozRnc=";
        pname = "${org}-${repo}";
