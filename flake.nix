...
{
  description = "Nix flake for pythoneda-artifact/code-request-application";
  inputs = rec {
    ...
    pythoneda-artifact-code-request-infrastructure = {
      ...
      url = "github:pythoneda-artifact-def/code-request-infrastructure/0.0.73";
    };
  ...
  outputs = inputs:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        version = "0.0.13";
        sha256 = "1npk7d5br2j0mzslj8xfc6ydscmlq4pw75fs91i7wzzlzfpj4k3i";
        pname = "${org}-${repo}";
      ...
      in rec {
        apps = rec {
          default = pythoneda-artifact-code-request-application-python312;
          ...
          pythoneda-artifact-code-request-application-python313 =
            shared.app-for {
              package =
                self.packages.${system}.pythoneda-artifact-code-request-application-python313;
              inherit entrypoint;
            };
        };
        ...
        devShells = rec {
          ...
          pythoneda-artifact-code-request-application-python313 =
            shared.devShell-for {
              ...
              nixpkgs-release = nixpkgsRelease;
              package =
                packages.pythoneda-artifact-code-request-application-python313;
        ...
        packages = rec {
          ...
          pythoneda-artifact-code-request-application-python313 =
            pythoneda-artifact-code-request-application-for {
              python = pkgs.python313;
              pythoneda-artifact-code-request-infrastructure =
                pythoneda-artifact-code-request-infrastructure.packages.${system}.pythoneda-artifact-code-request-infrastructure-python313;
              pythoneda-shared-pythonlang-application =
